...
export default function VehiclesAPIPage() {
    return (
        <div>
            <nav className="text-sm text-gray-500 mb-4">
                ...
                <span className="mx-2">/</span>
                <span className="text-gray-900">Vehicles API</span>
            </nav>

            <h1 className="text-3xl font-bold text-gray-900 mb-4">Vehicles API</h1>
            <p className="text-lg text-gray-600 mb-8">Endpoints for managing vehicles.</p>

            <div className="prose prose-gray max-w-none">
                <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">List Vehicles</h2>
                <div className="flex items-center gap-2 mb-4">
                    <span className="px-2 py-1 bg-green-100 text-green-700 font-mono text-sm rounded">GET</span>
                    <code className="text-gray-900">/api/vehicles</code>
                </div>

                <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Create Vehicle</h2>
                <div className="flex items-center gap-2 mb-4">
  ...
  "fuelType": "Diesel"
                ...
                <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Update Vehicle</h2>
                <div className="flex items-center gap-2 mb-4">
                    <span className="px-2 py-1 bg-yellow-100 text-yellow-700 font-mono text-sm rounded">PUT</span>
                    <code className="text-gray-900">/api/vehicles/:id</code>
                </div>

                <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Delete Vehicle</h2>
                <div className="flex items-center gap-2 mb-4">
